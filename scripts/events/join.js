...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("ROBBANI BOT IS BACK 😈👿!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
RoBBANI BOT CONNECTED SUCCESFUL !!! 
...
https://www.facebook.com/Robban543

🔵WHATSAPP NUMBER:NAI

🟢SUPPORT EMAIL:https://www.facebook.com/Robban543`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
